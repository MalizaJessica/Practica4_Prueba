...
public class ResultadoButtonListener implements OnClickListener {
    private MainActivityFragment mainActivityFragment;
    private Handler handler;

    public ResultadoButtonListener(MainActivityFragment mainActivityFragment) {
    ...
    public void onClick(View v) {
        ...
        if (guess.equals(answer)) {
            ...
            if (this.mainActivityFragment.getQuizViewModel().getCorrectAnswers()
                    == LogicaDePreguntas.getFlagsInQuiz()) {
                ResultadosDialogFragment quizResults = new ResultadosDialogFragment();
